            ...
            <div class="card rounded">
              <div class="card-body">
                <div class="d-flex align-items-center justify-content-between mb-2">
                  ...
                  <div>
                    <img class="wd-80 rounded-circle p-1 bg-primary" src="{{(!empty($profileData->photo)) ? url('uploads/agent_images/'.$profileData->photo) : url('uploads/no_image.jpg')}}" alt="agent">
          ...
          <div class="col-md-8 col-xl-8 middle-wrapper">
            <div class="row">
              ...
              <div class="card-body">
								...
								<form class="forms-sample" action="{{route('agent.profile.store')}}" method="POST" enctype="multipart/form-data">
                  @csrf
									<div class="mb-3">

...
@section('agent') 
			...
			<div class="page-content">
				...
				<nav class="page-breadcrumb">
					<ol class="breadcrumb">
						 <a href="{{route('agent.add.propertie')}}" class="btn btn-inverse-info">Add Properties</a>
					</ol>
				</nav>
                    ...
                    @foreach($property as $key => $item)  
                      <tr>
                        ...
                        <td>
                          ...
                          <a href="{{route('agent.delete.propertie', $item->id)}}" class="btn btn-inverse-danger" id="delete" title="Delete">

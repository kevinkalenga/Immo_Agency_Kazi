              ...
              <div class="input-group-text">
                ...
                <div class="p-1">
                  <a href="javascript:;" class="dropdown-item d-flex align-items-center py-2">
                    <div class="me-3">
                      <img class="wd-30 ht-30 rounded-circle" src="{{asset('https://via.placeholder.com/30x30')}}" alt="userr">
                    </div>
            ...
            <li class="nav-item dropdown">
							<a class="nav-link dropdown-toggle" href="#" id="profileDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
								<img id="showImage" src="{{(!empty($profileData->photo)) ? url('uploads/agent_images/'.$profileData->photo) : url('uploads/no_image.jpg')}}" alt="Agent" class="rounded-circle p-1 bg-primary" width="40">
							</a>
							<div class="dropdown-menu p-0" aria-labelledby="profileDropdown">
								<div class="d-flex flex-column align-items-center border-bottom px-5 py-3">
									<div class="mb-3">
								    <img id="showImage" src="{{(!empty($profileData->photo)) ? url('uploads/agent_images/'.$profileData->photo) : url('uploads/no_image.jpg')}}" alt="Agent" class="rounded-circle p-1 bg-primary" width="80">
									</div>

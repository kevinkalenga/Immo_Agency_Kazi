                            ...
                            <div class="post">
                                <figure class="post-thumb">
                                    <a href="blog-details.html">
                                        <img src="{{(!empty($userData->photo)) ? url('uploads/user_images/'.$userData->photo) : url('uploads/no_image.jpg')}}" alt="">
                                    </a>
                                </figure>
                        ...
                        <div class="deals-list-content list-item">
                            ...
                            <div class="deals-block-one">
                                <div class="inner-box">
                                    <div class="image-box">
                                        <figure class="image">
                                            <img src="{{asset('frontend/assets/images/resource/deals-3.jpg')}}" alt="">
                                        </figure>

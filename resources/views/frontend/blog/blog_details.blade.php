                                ...
                                <div class="inner-box">
                                    ...
                                    <div class="lower-content">
                                        ...
                                        <ul class="post-info clearfix">
                                            <li class="author-box">
                                                <figure class="author-thumb"><img src="{{(!empty($blog->user->photo)) ? url('uploads/admin_images/'.$blog->user->photo) : url('uploads/no_image.jpg')}}" alt=""></figure>
                                  ...
                                  @foreach($comment as $com)
                                    <div class="comment">
                                        <figure class="thumb-box">
                                            <img src="{{ (!empty($com->user->photo)) ? url('uploads/user_images/'.$com->user->photo) : url('uploads/no_image.jpg') }}" alt="">
                                        </figure>

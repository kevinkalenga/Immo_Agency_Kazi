                ...
                <div class="property-content-side">
                    ...
                    <div class="item-shorting clearfix">
                        <div class="left-column pull-left">
                            <h5>
                                Search Results:
                                <span>Showing {{count($bProperty)}} Listings</span>
                            </h5>
                        </div>
                    </div>
                        ...
                        <div class="deals-list-content list-item">
                            ...
                            <div class="deals-block-one">
                                <div class="inner-box">
                                    ...
                                    <div class="image-box">
                                        <figure class="image">
                                            <img src="{{asset($item->property_thambnail)}}" alt="" style="width:300px; height:360px;">
                                        </figure>
                                            ...
                                            <div class="author-box pull-right">
                                                @if($item->agent_id == Null)
                                                    <figure class="author-thumb">
                                                        <img src="{{url('uploads/admin_images/202605302123t1.jpg')}}" alt="">
                                                    </figure>
                                                    <h6>Admin</h6>
                                                @else
                                                    <figure class="author-thumb">
                                                        <img src="{{(!empty($item->user->photo)) ? url('uploads/agent_images/'.$item->user->photo) : url('uploads/no_image.jpg')}}" alt="">
                                                    </figure>
                    ...
                    <div class="pagination-wrapper">
                        <ul class="pagination clearfix">
                            {{$bProperty->links('vendor.pagination.custom')}}
                        </ul>
                    </div>
